    ...
    public void render() {
        ...
        if (hovered) {
            backgroundColor = new Color(
                    Math.min(backgroundColor.getRed() + 27, 255),
                    Math.min(backgroundColor.getGreen() + 27, 255),
                    Math.min(backgroundColor.getBlue() + 27, 255),
                    Math.min(backgroundColor.getAlpha() + 27, 255));
