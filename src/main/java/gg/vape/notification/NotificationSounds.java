...
public class NotificationSounds {
    ...
    public static final SoundClip MODULE_ENABLE;
    public static final SoundClip MODULE_DISABLE;
    ...
    static {
        try {
            String[] resourceNames = new String[]{"party_invite", "ping", "message_rec", "enable", "disable"};
            ...
            MODULE_ENABLE = new SoundClip(resourceNames[3]);
            MODULE_DISABLE = new SoundClip(resourceNames[4]);
        }
