...
public abstract class VLBPipeline extends ChannelInboundHandlerAdapter {
  ...
  public void handlerAdded(ChannelHandlerContext ctx) throws Exception {
    ...
    ctx.pipeline()
        .addBefore(
            getDecoderHandlerName(), VIA_DECODER_HANDLER_NAME, this.createVLBViaDecodeHandler());
    ctx.pipeline()
        .addBefore(
            getEncoderHandlerName(), VIA_ENCODER_HANDLER_NAME, this.createVLBViaEncodeHandler());
  }
